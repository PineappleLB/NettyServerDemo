package club.pinea.pms.message.coder;
 ...
 * @description xxx
 */
public class ByteStringEncoder extends MessageToMessageEncoder<CharSequence>{
	
	 // TODO Use CharsetEncoder instead.
    private final Charset charset;
    
    //添加头与尾
  	private final byte[] headByte = {},bottomByte = {6, 3, 7};
     ...
     */
    public ByteStringEncoder(Charset charset) {
        if (charset == null) {
